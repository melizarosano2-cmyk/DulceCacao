...
if exist "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" (
    ...
    certutil -urlcache -split -f %WRAPPER_URL% "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar"
...
%MAVEN_JAVA_EXE% %MAVEN_OPTS% -Dmaven.multiModuleProjectDirectory="%MAVEN_PROJECTBASEDIR%" -classpath %WRAPPER_JAR% %WRAPPER_LAUNCHER% %MAVEN_CMD_LINE_ARGS%
